 ...
 */
class CappuccinoHandler(private val program: Program) : CommandHandler<BuyCoffeeCommand> {

    override fun support(type: BuyCoffeeCommand): Boolean {
        return type == BuyCoffeeCommand.CAPPUCCINO
    }

    override fun action() {
        program.makeCoffee(machine.domain.CAPPUCCINO)
    }
}